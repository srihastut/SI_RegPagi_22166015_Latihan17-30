 ...
 */
package si_regpagi_22166015_latihan29_warna.kepribadian;
 ...
 */
public class SI_RegPagi_22166015_Latihan29_WarnaKepribadian {
    ...
    public static void main(String[] args) {
        ...
        switch (warna) {
            case "merah":
                System.out.println(foregroundHijau+"merah"+penutup);
                System.out.println("""
                                   1. Periang,
                                   2. Pemberani,
